...
void main()
{
	...
	cout << "Введите количество добовляемых элементов: ";   cin >> count;
	...
	cout << "Введите количество удоляемых элементов: ";   cin >> count;
...
#ifdef STL_LIST
	//list-контейнер который хранит данные ввиде двухсвязного списка.
